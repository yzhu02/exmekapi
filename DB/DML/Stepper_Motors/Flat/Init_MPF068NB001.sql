...
VALUES (
	'STEPPER_FLAT',				-- CATEGORY						-- STEPPER_STANDARD, STEPPER_FLAT, STEPPER_WITH_CONTROL
	@series,					-- SERIES
	@model,						-- MODEL					-- In case of STEPPER_LINEAR, it represents MODEL instead 
	'Flat Stepper Motor',		-- NAME
	NULL,						-- DESCRIPTION
...
SELECT ID, 'Rotor Inertia', 'g.cm²', '0.16' FROM STEPPER_MOTOR WHERE MODEL = @model
;
