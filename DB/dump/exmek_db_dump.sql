...
CREATE TABLE `MOTOR_CONFIG` (
  ...
  PRIMARY KEY (`ID`),
  KEY `IK_MOTOR_CONFIG_MODEL_REF` (`MODEL_REF`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `MOTOR_CONFIG` VALUES (2,0,'2024-08-10 01:11:28',NULL,'MB057GA*','curve.coordinates','[{\"name\": \"Tcont\", \"x\": \"Speed(Krpm)\", \"y\": \"Torque(oz-in)\"}, {\"name\": \"Tpeak\", \"x\": \"Speed(Krpm)\", \"y\": \"Torque(Ncm)\"}]'),(3,0,'2024-08-10 01:11:34',NULL,'MB059AH*','curve.coordinates','[{\"name\": \"\", \"x\": \"Torque(Nm)\", \"y\": \"Current(A)\"}, {\"name\": \"\", \"x\": \"Torque(Nm)\", \"y\": \"Speed(rpm)\"}]'),(4,0,'2024-08-10 01:11:40',NULL,'MB082GA*','curve.coordinates','[{\"name\": \"Torque(oz-in)\", \"x\": \"Speed(Krpm)\", \"y\": \"Torque(oz-in)\"}, {\"name\": \"Torque(Ncm)\", \"x\": \"Speed(Krpm)\", \"y\": \"Torque(Ncm)\"}]'),(5,0,'2024-08-13 21:01:49',NULL,'MP028NB*','curve.coordinates','[{\"x\": \"Frequency(Hz)\", \"y\": \"Torque(Ncm)\"}]');
