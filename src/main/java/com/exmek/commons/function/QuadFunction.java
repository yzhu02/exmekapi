...
public interface QuadFunction<T1, T2, T3, T4, R> {
     ...
     */
    default <W> QuadFunction<T1,T2, T3, T4, W> andThen(final Function<? super R, ? extends W> after) {
        Objects.requireNonNull(after);
        return (final T1 t1, final T2 t2, final T3 t3, T4 t4) -> after.apply(apply(t1, t2, t3, t4));
    }
}