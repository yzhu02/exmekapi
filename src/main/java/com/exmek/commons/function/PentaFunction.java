...
public interface PentaFunction<T1, T2, T3, T4, T5, R> {
     ...
     */
    default <W> PentaFunction<T1,T2, T3, T4, T5, W> andThen(final Function<? super R, ? extends W> after) {
        Objects.requireNonNull(after);
        return (final T1 t1, final T2 t2, final T3 t3, T4 t4, T5 t5) -> after.apply(apply(t1, t2, t3, t4, t5));
    }
}